...
class DepartmentController extends Controller
{
    ...
    public function edit(Department $department): View
    {
        ...
        return view('departments.edit', ['department' => $department, 'types' => DepartmentType::options()]);
    }
    ...
    public function destroy(Department $department): RedirectResponse
    {
        ...
        if ($department->users()->exists() || $department->visits()->exists() || $department->visitEvents()->exists()) {
